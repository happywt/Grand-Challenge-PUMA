...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = "/data/qlr/code/nuclear_segandcls/log/puma/0311_ori_all" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
        "/data/qlr/code/dataset/puma0311/ori205_3/pannuke/train/256x256_128x128"
