...
if __name__ == '__main__':
    folder_ref = '/data/hotaru/projects/nnUNet/nnunetv2/dataset/nnUNet_raw/Dataset001_puma/labelsTs'
    folder_pred = '/data/hotaru/projects/nnUNet/nnunetv2/dataset/nnUNet_raw/Dataset001_puma/imagesTs_predlowres'
    output_file = '/data/hotaru/projects/nnUNet/nnUNet_predict_result/Dataset001_result_0313/summary.json'
