...
if __name__ == "__main__":
    ...
    source = '/data/hotaru/projects/dataset/puma_png/aug0312'
    ...
    generate_dataset_json(join(nnUNet_raw, dataset_name), {0: 'R', 1: 'G', 2: 'B'},
                           {'background': 0, 'tissue_stroma': 1, 'tissue_blood_vessel': 2, 'tissue_tumor': 3, 'tissue_epidermis': 4, 'tissue_necrosis': 5},
