...
if __name__ == '__main__':
    ...
    nnUNet_results = './nnunetv2/dataset/nnUNet_results'
    nnUNet_raw = './nnunetv2/dataset/nnUNet_raw'
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset001_puma/nnUNetTrainer__nnUNetResEncUNetLPlans__2d'),
        use_folds=(5,),
        checkpoint_name='checkpoint_final.pth',
    )
    predictor.predict_from_files(join(nnUNet_raw, 'Dataset001_puma/images'),
                                 join(nnUNet_raw, 'Dataset001_puma/images_pred'),
